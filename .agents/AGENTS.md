# BasketCoach - AI Agents Governance

This document defines the specialized AI personas (Agents) designed to maintain the architectural integrity and code quality of the **BasketCoach** project using **MVVM** and **Hilt**.
...
**Expertise**: Dependency Injection (**Hilt**), Module Configuration, and **Dependency Integrity**.
...
**Expertise**: UI Frameworks (Jetpack Compose, XML), Design Systems (Material 3), and State Management (**MVVM**).
...
4. **DI Coordinator** provides the new dependencies via **Hilt**.
5. **UI/UX Engineer** builds the screen (Wiring + Content) and state holder using **MVVM**.
